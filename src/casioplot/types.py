...
class Configuration(TypedDict):
    ...
    # showing_screen
    show_screen: (
        bool  # do not mistake for the function `show_screen` from `casioplot.py
    )
    ...
    correct_colors: bool  # the casio calculators don't have the same precision for colors as the computer
    # this option makes the set_pixel function correct the colors to match what would happen in the calculators

    debugging_messages: bool  # activates debugging messages that warn if the program is trying to use get_pixel,
